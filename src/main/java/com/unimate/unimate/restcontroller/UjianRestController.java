...
public class UjianRestController {
    ...
    @Autowired
    public UjianRestController(UjianService ujianService, UjianSiswaService ujianSiswaService, QuestionService questionService){
    ...
    public ResponseEntity<?> gradeUjian(@RequestBody UjianResultDTO ujianResultDTO) {
        ...
        Double grade = (double) questionsCorrect / ujianResultDTO.getList().size() * 100;
